...
violent_crimes=['Robbery']

trend=multi_year.loc[ (multi_year['NIBRSDescription'].isin(violent_crimes))]
trend['NIBRSDescription']='Robbery'

ytd_over=YTD(trend,'Robbery')
...
def mon_heatmap(start,end):
    ...
    hm.save(f'''C:/Users/chris/Documents/Random_Nextdoor/My_Crime_Analysis - 05.04.23/Group/Robbery_HeatMap_{start}.html''')
...
def map_plot(start,end):
    ...
    m.save(f'''C:/Users/chris/Documents/Random_Nextdoor/My_Crime_Analysis - 05.04.23/Group/Robbery_{start}.html''')
...
def cluster_incidents(start,end,n_neur=12):
    ...
    clu_m.save(f'''C:/Users/chris/Documents/Random_Nextdoor/My_Crime_Analysis - 05.04.23/Group/Robbery_Cluster_{start}.html''')
...
def map_plot(start,end):
    ...
    m.save(f'''C:/Users/chris/Documents/Random_Nextdoor/My_Crime_Analysis - 05.04.23/Group/Robbery_time.html''')
...
def premise( start
    ...
    print( 'Top 5 Premises of Robbery Crimes\n'
...
agg_df[['RMSOccurrenceHour','perc']].plot( kind='bar'
            ,x='RMSOccurrenceHour'
            ,figsize=(12,6)
            ,title=f'''Robbery Incident Counts By OccurrenceHour{ (2022)}''')
