...
property_crimes=[ 'Burglary, Breaking and Entering'
                 ,'All other larceny'
                 ,'Motor vehicle theft'
...
def mon_heatmap(start,end):
    ...
    hm.save(f'''C:/Users/chris/Documents/Random_Nextdoor/My_Crime_Analysis - 05.04.23/Group/property_HeatMap_{start}.html''')
...
def map_plot(start,end):
    ...
    m.save(f'''C:/Users/chris/Documents/Random_Nextdoor/My_Crime_Analysis - 05.04.23/Group/property_{start}.html''')
...
def cluster_incidents(start,end,n_neur=12):
    ...
    clu_m.save(f'''C:/Users/chris/Documents/Random_Nextdoor/My_Crime_Analysis - 05.04.23/Group/property_Cluster_{start}.html''')
...
def premise( start
    ...
    print( 'Top 5 Premises of property Crimes\n'
